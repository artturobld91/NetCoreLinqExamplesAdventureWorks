...
namespace NetCoreLinqExamples.Models
{
    /// <summary>
    /// Execute the following command to scaffold and create models and context classes.
    /// Scaffold-DbContext "Server=EPMXGUAW2099;Database=AdventureWorks2019;Trusted_Connection=True;MultipleActiveResultSets=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models
    /// </summary>
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=EPMXGUAW2099;Database=AdventureWorks2019;Trusted_Connection=True;MultipleActiveResultSets=true;");
            }
        }
